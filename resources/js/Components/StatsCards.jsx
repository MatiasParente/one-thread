import { MessageSquare, AlertTriangle, Clock, TrendingUp, TrendingDown, Minus } from 'lucide-react';
...
export default function StatsCards({ stats }) {
    return statConfig.map(({ key, label, icon: Icon, borderColor, iconBg, iconColor }) => {
